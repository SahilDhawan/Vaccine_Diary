...
class VaccinationList : NSObject
{
    ...
    func setVaccineList() {
        ...
        //EighteenMonths
        VaccinationSchedule.append(Vaccine("DTwP B1",UserDetails.VaccinationDates.eighteenMonthsDate,eighteenMonthBool, "DPT (also DTP and DTwP) refers to a class of combination vaccines against three infectious diseases in humans: diphtheria, pertussis (whooping cough), and tetanus. The vaccine components include diphtheria and tetanus toxoids and killed whole cells of the organism that cause pertussis (wP).\nDTaP and Tdap refer to similar combination vaccines in which the component with lower case \"a\" is acellular.\nAlso available is the DT or TD vaccine, which lacks the pertussis component. The Tdap vaccine is currently recommended by the CDC and covers tetanus, diphtheria and pertussis (CDC Vaccines, 2013)."))
    ...
    func createVaccinationDates(){
        UserDetails.VaccinationDates.sixWeeksDate = gregorian.date(byAdding: .day, value: 42, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.tenWeeksDate = gregorian.date(byAdding: .day, value: 70, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.fourteenWeeksDate = gregorian.date(byAdding: .day, value: 98, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.sixMonthsDate = gregorian.date(byAdding: .month, value: 6, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.nineMonthsDate = gregorian.date(byAdding: .month, value: 9, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.oneYearDate = gregorian.date(byAdding: .year, value: 1, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.fifteenMonthsDate = gregorian.date(byAdding: .month, value: 15, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.eighteenMonthsDate = gregorian.date(byAdding: .month, value: 18, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.twoYearDate = gregorian.date(byAdding: .year, value: 2, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.sixYearDate = gregorian.date(byAdding: .year, value: 6, to: UserDetails.userBirthDate)!
        UserDetails.VaccinationDates.twelveYearDate = gregorian.date(byAdding: .year, value: 12, to: UserDetails.userBirthDate)!
    }
